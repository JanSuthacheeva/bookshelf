...
func (app *application) routes() http.Handler {
	...
	mux.Handle("GET /sessions/create", dynamic.ThenFunc(app.getSessionCreate))
	mux.Handle("POST /sessions/create", dynamic.ThenFunc(app.postSessionCreate))
	...
	mux.Handle("POST /sessions/delete", dynamic.ThenFunc(app.postSessionDelete))
