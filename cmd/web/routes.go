...
func (app *application) routes() http.Handler {
  ...
  mux.Handle("/", dynamic.ThenFunc(app.getDashboard))
  ...
  mux.Handle("POST /register", dynamic.ThenFunc(app.postRegister))
  mux.Handle("POST /logout", dynamic.ThenFunc(app.postLogout))
