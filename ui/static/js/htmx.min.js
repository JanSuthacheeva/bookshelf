...
var htmx = function() {
    ...
    function dt(t, n, e) {
        if (t instanceof HTMLAnchorElement && at(t) && (t.target === "" || t.target === "_self") || t.tagName === "FORM" && String(ee(t, "method")).toLowerCase() !== "dialog") {
            n.boosted = true;
            let r, o;
            if (t.tagName === "A") {
                r = "get";
    ...
    const Ot = (new XPathEvaluator).createExpression('.//*[@*[ starts-with(name(), "hx-on:") or starts-with(name(), "data-hx-on:") or' + ' starts-with(name(), "hx-on-") or starts-with(name(), "data-hx-on-") ]]');
    ...
    function Tt(e) {
        if (e.querySelectorAll) {
            ...
            const o = e.querySelectorAll(O + n + ", form, [type='submit']," + " [hx-ext], [data-hx-ext], [hx-trigger], [data-hx-trigger]" + r.flat().map(e => ", " + e).join(""));
            return o
        } else {
            return []
        }
    ...
    function qn(e, t, n) {
        ...
        return de(e, "htmx:validateUrl", ue({
            url: o,
            sameHost: r
        }, n))
    }
    ...
    function Mn(o, i) {
        ...
        if (m.shouldSwap) {
            ...
            let e = function() {
                try {
                    if (c.type) {
                        de(ne().body, "htmx:beforeHistoryUpdate", ue({
                            history: c
                        }, i));
                        if (c.type === "push") {
                            Jt(c.path);
